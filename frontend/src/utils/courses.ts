export const COURSES = [
  ...
  "Informatyka - Zarządzanie Bezpieczeństwem Informacji",
  ...
  "Inżynieria i Zarządzanie w Energetyce Jądrowej",
  ...
  "TechMet – Metale Ziem Rzadkich i Surowce Strategiczne",
  ...
  "Zarządzanie Łańcuchami Dostaw w Branży Metali Nieżelaznych",
